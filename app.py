...
model_cats = [
    feature for feature in model_features if feature in encoder.feature_names_in_
...
def predict():
    ...
    if modified_encoder != None:
        df[model_cats] = modified_encoder.fit_transform(
            df[model_cats]
