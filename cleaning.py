...
def preprocessing(read_csv):
    ...
    df_cats = df.select_dtypes(include=['object']).columns.tolist() # categorical features of the dataframe
...
cleaned_df = preprocessing(r"C:\Users\JUNAID AHMED\Downloads\datasets\Thesis dataset\Living_Standard.csv")
